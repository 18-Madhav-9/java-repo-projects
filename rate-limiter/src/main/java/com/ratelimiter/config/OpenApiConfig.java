...
/**
 * OpenAPI 3 metadata configuration for V3.1.
 */
@Configuration
                                ...
                                .info(new Info()
                                                ...
                                                .description("""
                                                                **Production-ready pluggable rate limiting framework** with per-endpoint limits.
                                                                ...
                                                                - 🔧 **Admin APIs**: Live stats, active keys, config, store info
                                                                - 🗄️ **Redis store**: Lua-script atomicity, TTL-based expiry, horizontal scaling
                                                                - 🔄 **Configurable failure mode**: fail-open, fail-closed, or fallback to in-memory
